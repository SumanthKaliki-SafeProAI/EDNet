...
from ednet.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    """
    Handles dynamic backend selection for running inference using YOLO models.
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from ednet.nn.tasks import attempt_load_weights
        ...
        # TensorRT
            ...
            check_version(trt.__version__, "<=10.1.0", msg="issues 14239")
            if device.type == "cpu":
        ...
        # TF GraphDef
            ...
            from ednet.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from ednet.utils.triton import TritonRemoteModel

            model = TritonRemoteModel(w)

        # Any other format (unsupported)
        else:
            from ednet.engine.exporter import export_formats
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        # CoreML
            ...
            if "confidence" in y:
                raise TypeError(
                    "Only supports inference of non-pipelined CoreML models exported with "
